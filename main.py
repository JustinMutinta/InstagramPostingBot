...
#shutil.rmtree('config') deletes the config folder in your directory. config folder is created the first time you create the bot object, but needs to be deleted for it to run again
